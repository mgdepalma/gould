 ...
 *
 * Copyright	2013 Generations Linux <bugs@softcraft.org>
 *		2008 Red Hat, Inc.
...
language_name_has_translations (const char *language_name)
{
        ...
        path = g_build_filename (LOCALEDIR, language_name, "LC_MESSAGES", NULL);
...
collect_locales_from_directory (void)
{
        ...
        g_debug ("Reading possible locales from %s", LIBLOCALEDIR);
